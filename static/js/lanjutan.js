document.addEventListener("DOMContentLoaded", () => {
  ...
  dataForm.addEventListener("submit", (e) => {
    ...
    const memilikiPekerjaan =
      document.getElementById("memiliki_pekerjaan").value;
    const statusPekerjaanDiinginkan = document.getElementById(
    ...
    if (
      memilikiPekerjaan === "Tidak" &&
      !statusPekerjaanDiinginkan.value.trim()
    ) {
      document
        .getElementById("status_pekerjaan_diinginkan_error")
    ...
    if (
      statusPekerjaanDiinginkan.value === "Berusaha Sendiri" &&
        ...
        .then((data) => {
          ...
          if (data.success) {
            ...
            if (data.continue_next_member) {
              ...
              clearSavedData(); // Declare clearSavedData function or import it here
              dataForm.reset();
              updateNamaPlaceholders("");

              // Hide conditional sections
              document
                .getElementById("status_pekerjaan_container")
                .classList.add("hidden");
              document
                .getElementById("bidang_usaha_container")
                .classList.add("hidden");
              ...
              // Don't clear saved data when going to final page
              // This allows user to go back and edit
              setTimeout(() => {
...
window.checkMemilikiPekerjaan = () => {
  ...
  const statusPekerjaanContainer = document.getElementById(
    "status_pekerjaan_container"
  );
  const bidangUsahaContainer = document.getElementById(
    "bidang_usaha_container"
  );
